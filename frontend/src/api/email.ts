...
export const emailApi = {
  ...
  listAccounts: async (): Promise<EmailAccount[]> => {
    const response = await client.get<ApiResponse<EmailAccount[]>>('/email/accounts')
  ...
  createAccount: async (data: {
    ...
    const response = await client.post<ApiResponse<EmailAccount>>('/email/accounts', data)
    return response.data.data
  },

  getAccount: async (id: number): Promise<EmailAccount> => {
    const response = await client.get<ApiResponse<EmailAccount>>(`/email/accounts/${id}`)
    return response.data.data
  },
  ...
  updateAccount: async (id: number, data: {
    ...
    const response = await client.put<ApiResponse<EmailAccount>>(`/email/accounts/${id}`, data)
    return response.data.data
  },
  ...
  listForwarders: async (): Promise<EmailForwarder[]> => {
    const response = await client.get<ApiResponse<EmailForwarder[]>>('/email/forwarders')
    return response.data.data
  },
  ...
  createForwarder: async (data: {
    ...
    const response = await client.post<ApiResponse<EmailForwarder>>('/email/forwarders', data)
    return response.data.data
  },
  ...
  listAutoresponders: async (): Promise<EmailAutoresponder[]> => {
    const response = await client.get<ApiResponse<EmailAutoresponder[]>>('/email/autoresponders')
    return response.data.data
  },
  ...
  createAutoresponder: async (data: {
    ...
    const response = await client.post<ApiResponse<EmailAutoresponder>>('/email/autoresponders', data)
    return response.data.data
  },

  updateAutoresponder: async (id: number, data: Partial<{
    subject: string
    body: string
    start_time?: string
    end_time?: string
    ...
    const response = await client.put<ApiResponse<EmailAutoresponder>>(`/email/autoresponders/${id}`, data)
    return response.data.data
  },
