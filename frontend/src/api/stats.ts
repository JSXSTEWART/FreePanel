...
export const statsApi = {
  getBandwidth: async (
    ...
    const response = await client.get<ApiResponse<BandwidthStats>>(
      "/stats/bandwidth",
      {
        params: { period },
      },
  ...
  getVisitors: async (params?: {
    ...
    const response = await client.get<ApiResponse<VisitorStats>>(
      "/stats/visitors",
      { params },
    );
    return response.data.data;
  ...
  getErrors: async (params?: {
    ...
    const response = await client.get<ApiResponse<ErrorStats>>(
      "/stats/errors",
      { params },
    );
    return response.data.data;
  ...
  getResourceUsage: async (): Promise<ResourceUsage> => {
    const response = await client.get<ApiResponse<ResourceUsage>>(
